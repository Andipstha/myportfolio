...
const mouseCircleTransform = (hoveredEl) => {
    if (hoveredEl.classList.contains("pointer-enter")) {
        hoveredEl.onmousemove = () => {
            ...
            transition: width .2s, height .2s, top .2s, left .2s, transform .2s, border-radius .2s;
            `;
        };
...
// const aboutMeTextContent = 'As a Graphic Designer, Web Developer, and Software Developer, I am passionate about my work. I enjoy coding and developing new products. I design and create artworks for people, which helps them reach their goals. I also push myself by learning new things and taking up challenges.I am a self-motivated and hardworking individual. I have experience working with different types of people and clients in order to create the best possible product. I am highly organized, dependable, and detail oriented. My experience has taught me how important it is to communicate effectively with others.I am a team player who is able to work independently as well. I have a passion for technology and I love learning about new things. My goal is to create innovative products that will help people’s lives easier and better.';
const aboutMeTextContent = 'Passionate creator of digital wonders, blending design and code.';
...
projectsBtn.addEventListener('click', (e) => {
    ...
    projects.forEach((project, i) => {
        ...
        // The above code is doing the exact same thing as this code:
        // if(i >= 6){
        // if(showHideBool){
